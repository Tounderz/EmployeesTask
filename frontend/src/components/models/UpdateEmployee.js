...
import { updateEmployee } from '../../http/employeeApi';
import { useInput } from '../../http/validateApi';
import { Context } from '../../index';

const UpdateEmployee = ({show, onHide}) => {
    ...
    const dateOfBirth = useInput(new Date(), {age: {name: 'Date Of Birth'}} );
    const residentialAddress = useInput('', {minLength: {value: 8, name: 'Residential Address'}} );
    ...
    const click = async () => {
        try {
            const data = await updateEmployee(employee.selectedEmployee.id, name.value, surname.value, patronymic.value, dateOfBirth.value, residentialAddress.value, department.value, aboutMe.value);
            ...
            <Modal.Body>
                ...
                <Form>
                    ...
                    <Form.Control
                        ...
                        placeholder={employee.selectedEmployee.name}
                    />
                    ...
                    <Form.Control
                        ...
                        placeholder={employee.selectedEmployee.surname}
                    />
                    ...
                    <Form.Control
                        ...
                        placeholder={employee.selectedEmployee.patronymic}
                    />
                    ...
                    <Form.Control
                        ...
                        placeholder={employee.selectedEmployee.dateOfBirth}
                    />

                    {(residentialAddress.isDirty && residentialAddress.minLengthError) && 
                        <div className='mt-3' style={{color: 'red'}}>{residentialAddress.messageError}</div>
                    }
                    <Form.Control
                        className='mt-3'
                        ...
                        placeholder={employee.selectedEmployee.residentialAddress}
                    />
                    ...
                    <Form.Control
                        ...
                        placeholder={employee.selectedEmployee.department}
                    />
                    ...
                    <Form.Control
                        ...
                        placeholder={employee.selectedEmployee.aboutMe}
                    />
                </Form>
            </Modal.Body>
            <Modal.Footer>
                <button
                    ...
                    disabled={!name.inputValid && !surname.inputValid && !patronymic.value && !dateOfBirth.inputValid && !residentialAddress.inputValid && !department.inputValid && !aboutMe.inputValid}
                    onClick={click}
                >
                    Update
                </button>
